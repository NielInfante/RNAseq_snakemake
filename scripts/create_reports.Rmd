...
## Significant Genes
A total of `r dim(sig)[1]` genes were counted as significant in this test. Genes are counted as significant if their base mean is above `r round(2^cut_value)`, the adjusted p value is below 0.05, and there is a fold change of at least 1.5.
