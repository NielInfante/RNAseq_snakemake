...
print("now for the image")
#![Graph Missing](`r paste0("../results/", exp, "/MF_bar.png)")`)	
#`r print(paste0("../results/", exp, "/GO/MF_bar.png)"))`
#`r paste0("../results/", exp, "/GO/MF_bar.png)")`
#![Graph Missing](../results/120d/GO/MF_bar.png)	
#![Graph Missing](results/120d/GO/MF_bar.png)	
#![](`r paste0(snakemake@scriptdir, "/results/120d/GO/MF_bar.png")`)


#grid::rasterGrob(png::readPNG(paste0(snakemake@scriptdir, "/../results/", exp, "/GO/MF_bar.png)")))

library(magick)
library(cowplot)
ggdraw() + draw_image(paste0(snakemake@scriptdir, "/../results/", exp, "/GO/MF_bar.png)"))
```
